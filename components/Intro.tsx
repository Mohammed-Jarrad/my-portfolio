...
const Intro = () => {
    ...
    return (
        <section id="home" className="text-center scroll-mt-28" ref={introRef}>
            <div className="relative flex-center w-fit mx-auto">
                ...
                >
                    <motion.img
                        ...
                        className="max-[400px]:h-[15rem] max-[400px]:w-[15rem] w-72 h-72  rounded-full object-contain shadow-xl border-[0.35rem] border-white"
                        initial={{ y: 0 }}
                        animate={{ y: [-4, 4] }}
                        transition={{
                            duration: 1,
                ...
                <motion.span
                    className="absolute text-5xl bottom-3 right-3"
                    initial={{ opacity: 0, scale: 0 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{
                        type: "spring",
            ...
            >
                <div className="font-medium text-xl sm:text-2xl font-comfortaa capitalize bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-gray-900 dark:from-rose-300 dark:to-rose-100">
                    <AnimatePresence>
                        {name.current
                            .split("")
                            .slice(0, indicator)
            ...
            <motion.p
                className="text-gray-500 font-comfortaa text-lg font-extralight mt-5 max-w-xl dark:text-gray-400"
                initial={{ y: 100, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
            ...
            >
                ...
                >
                    Contact Me Here{" "}
                    <MdOutlineArrowRightAlt className="group-hover:translate-x-1 transition" />
                </Link>
                ...
                <div className="flex-center gap-4">
                    <a
                        href={personalDetails.linkdIn.href}
                        target="_blank"
                        className="info_button group"
                    >
                        <BiLogoLinkedin className="group-hover:scale-[1.1] transition" />
                    </a>
                    <a
                        href={personalDetails.github.href}
                        target="_blank"
                        className="info_button group"
                    >
