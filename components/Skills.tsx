		...
		<section ref={ref} id="skills" className="scroll-mt-28">
			...
			<ul className="flex-center flex-wrap gap-4 max-w-lg">
				{skillsData.map((skill, idx) => (
					...
					>
						<motion.span
							className="inline-block bg-white  shadow-2xl text-gray-800 border border-black/10 py-1 px-3 capitalize rounded-lg font-rubik dark:bg-white/20 dark:text-gray-300 "
							variants={{
								hidden: { scale: 0 },
