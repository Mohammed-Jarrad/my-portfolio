...
export function Project({
    ...
    return (
        <motion.article
            className="relative rounded-lg shadow-[0px_2px_5px_rgba(0,0,0,0.1)] overflow-hidden mb-4 md:mb-8 md:min-h-[25rem] bg-gray-50 hover:bg-gray-100 transition dark:bg-[#FFFFFF0D] dark:border-gray-600 flex items-center gap-4 lg:even:flex-row-reverse max-lg:flex-col max-lg:justify-between p-4"
            ref={articleRef}
        >
            {/* Content */}
            ...
            >
                <Image
                    ...
                    quality={95}
                    className={`size-full object-cover rounded-lg shadow-2xl`}
                />
            </motion.div>
        </motion.article>
    );
